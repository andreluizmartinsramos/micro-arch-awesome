...
return $this->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Command\\AppUsuarioCreateCommand' => function (): \App\Command\AppUsuarioCreateCommand {
    return ($this->privates['App\Command\AppUsuarioCreateCommand'] ?? $this->load('getAppUsuarioCreateCommandService.php'));
...
}, 'snc_redis.command.flush_all' => function (): \Snc\RedisBundle\Command\RedisFlushallCommand {
    return ($this->privates['snc_redis.command.flush_all'] ?? $this->load('getSncRedis_Command_FlushAllService.php'));
}, 'snc_redis.command.flush_db' => function (): \Snc\RedisBundle\Command\RedisFlushdbCommand {
    return ($this->privates['snc_redis.command.flush_db'] ?? $this->load('getSncRedis_Command_FlushDbService.php'));
