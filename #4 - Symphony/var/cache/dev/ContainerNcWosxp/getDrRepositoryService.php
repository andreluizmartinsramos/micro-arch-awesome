...
// Returns the private 'App\Repository\DrRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DrRepository.php';

return $this->privates['App\Repository\DrRepository'] = new \App\Repository\DrRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
