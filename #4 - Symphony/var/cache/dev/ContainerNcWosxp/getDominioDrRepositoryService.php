...
// Returns the private 'App\Repository\DominioDrRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/DominioDrRepository.php';

return $this->privates['App\Repository\DominioDrRepository'] = new \App\Repository\DominioDrRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
